...
import {BaseContainer, Avatar, SearchResults, Styles, TaskOverview, BrewNotification} from "../components";
...
class Results extends Component {
    ...
    const { navigation} = this.props;
        ...
        return <List style={{backgroundColor: "#e8e8e8"}}>
            {
                _.map(tasks, (task, key) => <BrewNotification  navigation ={navigation} {...{task, key}} />)
            }
            </List>
