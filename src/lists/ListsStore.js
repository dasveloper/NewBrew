...
export default class ListsStore {
  ...
  @computed get taskKey(): string { return this._taskKey; }
  set taskKey(taskKey: string) { this._taskKey = taskKey; }
    ...
    async foobar(): Promise<void> {
      ...
      await Firebase.userRef.child(`votes/upvotes//${Object.keys(this.task)[0]}`).set(this.task[Object.keys(this.task)[0]]);
